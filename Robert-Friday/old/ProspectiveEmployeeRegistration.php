...
<div id="wrapper">
    ...
    <dl>
      ...
      <dt>Email:</dt><dd><?php echo $_POST["city"]?></dd>
      <dt>Phone:</dt><dd><?php echo $_POST["occupation"]?></dd>
	  <dt>User ID:</dt><dd><?php echo $_POST["user_name"]?></dd>
    </dl>

<?php

$sql = "INSERT INTO users (first_name, last_name, city, occupation, employer, user_name, password)
VALUES(:first_name, :last_name,:city,:occupation, :employer, :user_name, :password)"; //not presently sure how to handle the files

$hashedpassword=md5($_POST["pass"]);

try {
$st = $conn->prepare( $sql );
$st->bindValue( ":first_name", $_POST["first_name"], PDO::PARAM_STR );
$st->bindValue( ":last_name", $_POST["last_name"], PDO::PARAM_STR );
